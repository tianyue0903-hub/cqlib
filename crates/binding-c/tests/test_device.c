...
// Topology functions
TopologyWrapper* topology_new(const uint32_t* qubits, size_t num_qubits, const uint64_t* couplings,
...
int topology_is_connected(const TopologyWrapper* ptr, uint32_t control, uint32_t target);
...
int device_add_qubit_properties(DeviceWrapper* ptr, uint32_t qubit_idx, QubitPropWrapper* prop);
...
void test_topology_creation() {
    ...
    TopologyWrapper* topo = topology_new(qubits, num_qubits, couplings, num_couplings);
    ...
    ASSERT_EQ(topology_num_couplings(topo), 2, "test_topology_creation: 2 couplings");

    // Verify connectivity
    ASSERT_EQ(topology_is_connected(topo, 0, 1), 1, "test_topology_creation: 0-1 connected");
    ASSERT_EQ(topology_is_connected(topo, 1, 2), 1, "test_topology_creation: 1-2 connected");
    ASSERT_EQ(topology_is_connected(topo, 2, 1), 0, "test_topology_creation: 2-1 not connected");
...
void test_topology_line() {
    ...
    ASSERT_EQ(topology_is_connected(topo, 0, 1), 1, "test_topology_line: 0-1 connected");
    ASSERT_EQ(topology_is_connected(topo, 1, 2), 1, "test_topology_line: 1-2 connected");
    ASSERT_EQ(topology_is_connected(topo, 0, 2), 0, "test_topology_line: 0-2 not connected");
...
void test_topology_edge_cases() {
    ...
    ASSERT_EQ(topology_num_qubits(NULL), 0, "test_topology_edge_cases: NULL qubits count");
    ASSERT_EQ(topology_num_couplings(NULL), 0, "test_topology_edge_cases: NULL couplings count");
    ...
    ASSERT_EQ(topology_num_qubits(topo), 1, "test_topology_edge_cases: Single qubit count");
    topology_free(topo);
}
...
void test_qubit_prop_unset_values() {
    ...
    ASSERT_DOUBLE_EQ(qubit_prop_get_t1(prop), -1.0, "test_qubit_prop_unset_values: Unset T1");
    ASSERT_DOUBLE_EQ(qubit_prop_get_t2(prop), -1.0, "test_qubit_prop_unset_values: Unset T2");
...
void test_qubit_prop_null_pointer() {
    ...
    ASSERT_EQ(qubit_prop_set_t1(NULL, 10.0), -1, "test_qubit_prop_null_pointer: Set T1 on NULL");
    ASSERT_EQ(qubit_prop_set_t2(NULL, 20.0), -1, "test_qubit_prop_null_pointer: Set T2 on NULL");
    ASSERT_DOUBLE_EQ(qubit_prop_get_t1(NULL), -1.0, "test_qubit_prop_null_pointer: Get T1 on NULL");
...
void test_device_default_properties() {
    ...
    ASSERT_EQ(device_set_default_t1(device, 30.0), 0, "test_device_default_properties: Set T1");

    // Test default T2 (setter only - getter not implemented)
    ASSERT_EQ(device_set_default_t2(device, 60.0), 0, "test_device_default_properties: Set T2");
...
void test_device_qubit_properties() {
    ...
    // Query properties
    ASSERT_DOUBLE_EQ(device_get_t1(device, 0), 30.0, "test_device_qubit_properties: Qubit 0 T1");
    ASSERT_DOUBLE_EQ(device_get_t2(device, 0), 60.0, "test_device_qubit_properties: Qubit 0 T2");
...
void test_device_multiple_qubits() {
    ...
    ASSERT_DOUBLE_EQ(device_get_t1(device, 0), 35.0, "test_device_multiple_qubits: Qubit 0 T1");
    ASSERT_DOUBLE_EQ(device_get_t1(device, 1), 20.0,
                     "test_device_multiple_qubits: Qubit 1 T1 (default)");
    ASSERT_DOUBLE_EQ(device_get_t1(device, 2), 40.0, "test_device_multiple_qubits: Qubit 2 T1");
...
void test_device_null_pointer() {
    ...
    ASSERT_EQ(device_num_qubits(NULL), 0, "test_device_null_pointer: NULL num_qubits");
...
void test_device_topology_retrieval() {
    ...
    ASSERT_NOT_NULL(retrieved_topo, "test_device_topology_retrieval: Retrieve topology");
...
void test_complex_topology_device() {
    ...
    ASSERT_NOT_NULL(topo, "test_complex_topology_device: Create complex topology");
    ...
    ASSERT_EQ(device_num_qubits(device), 6, "test_complex_topology_device: Total qubits");
    ASSERT_DOUBLE_EQ(device_get_default_single_qubit_error(device), 0.001,
                     "test_complex_topology_device: Default single-qubit error");
    ASSERT_DOUBLE_EQ(device_get_default_two_qubit_error(device), 0.01,
                     "test_complex_topology_device: Default two-qubit error");

    ASSERT_DOUBLE_EQ(device_get_t1(device, 0), 20.0, "test_complex_topology_device: Qubit 0 T1");
    ASSERT_DOUBLE_EQ(device_get_readout_error(device, 0), 0.01,
                     "test_complex_topology_device: Qubit 0 readout error");

    ASSERT_DOUBLE_EQ(device_get_t1(device, 5), 40.0, "test_complex_topology_device: Qubit 5 T1");
