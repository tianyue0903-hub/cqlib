...
class EntanglementTopology:
    ...
    def generate_k_tuples(self, k: int, num_qubits: int) -> list[list[int]]:
    ...
    def __copy__(self) -> "EntanglementTopology": ...
    def __deepcopy__(self, memo: dict) -> "EntanglementTopology": ...
...
class TwoLocal:
    ...
    def __init__(self, num_qubits: int) -> None:
        ...
        Defaults:
            - 3 repetitions, RY rotation, CX entanglement, Linear topology.
        """
        ...
    ...
    def __repr__(self) -> str: ...
    def __str__(self) -> str: ...
    def __copy__(self) -> "TwoLocal": ...
    def __deepcopy__(self, memo: dict) -> "TwoLocal": ...
